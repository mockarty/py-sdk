...
class FuzzingAPI(SyncAPIBase):
    ...
    def import_from_curl(self, data: dict[str, Any]) -> dict[str, Any]:
        ...
        resp = self._request(
            "POST", "/api/v1/fuzzing/import/curl", json=data
        )
        return resp.json()
    ...
    def import_from_openapi(self, data: dict[str, Any]) -> dict[str, Any]:
        ...
        resp = self._request(
            "POST", "/api/v1/fuzzing/import/openapi", json=data
        )
        return resp.json()
    ...
    def import_from_recorder(self, data: dict[str, Any]) -> dict[str, Any]:
        ...
        resp = self._request(
            "POST", "/api/v1/fuzzing/import/recorder", json=data
        )
        return resp.json()
    ...
    def import_from_mock(self, data: dict[str, Any]) -> dict[str, Any]:
        ...
        resp = self._request(
            "POST", "/api/v1/fuzzing/import/mock", json=data
        )
        return resp.json()
    ...
    def create_schedule(self, schedule: dict[str, Any]) -> dict[str, Any]:
        ...
        resp = self._request(
            "POST", "/api/v1/fuzzing/schedules", json=schedule
        )
        return resp.json()
...
class AsyncFuzzingAPI(AsyncAPIBase):
    ...
    async def quick_fuzz(self, request: dict[str, Any]) -> dict[str, Any]:
        ...
        resp = await self._request(
            "POST", "/api/v1/fuzzing/quick-fuzz", json=request
        )
        return resp.json()
    ...
    async def get_finding(self, finding_id: str) -> dict[str, Any]:
        """Get a specific fuzzing finding."""
        resp = await self._request(
            "GET", f"/api/v1/fuzzing/findings/{finding_id}"
        )
        return resp.json()
    ...
    async def import_from_collection(
        self, data: dict[str, Any]
    ) -> dict[str, Any]:
        """Import fuzzing targets from a collection."""
        resp = await self._request(
    ...
    async def import_from_recorder(
        self, data: dict[str, Any]
    ) -> dict[str, Any]:
        """Import fuzzing targets from a recorder session."""
        resp = await self._request(
    ...
    async def delete_schedule(self, schedule_id: str) -> None:
        """Delete a fuzzing schedule."""
        await self._request(
            "DELETE", f"/api/v1/fuzzing/schedules/{schedule_id}"
        )
