...
class MockBuilder:
    ...
    def http(route: str, method: str = "GET") -> MockBuilder:
        ...
        builder._mock_data["http"] = HttpRequestContext(route=route, http_method=method)
        return builder
    ...
    def grpc(service: str, method: str) -> MockBuilder:
        ...
        builder._mock_data["grpc"] = GrpcRequestContext(service=service, method=method)
        return builder
    ...
    def mcp(tool: str) -> MockBuilder:
        ...
        builder._mock_data["mcp"] = MCPRequestContext(method="tools/call", tool=tool)
        return builder
    ...
    def soap(service: str, method: str) -> MockBuilder:
        ...
        builder._mock_data["soap"] = SoapRequestContext(service=service, method=method)
        return builder
