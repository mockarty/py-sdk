...
class HttpRequestContext(BaseModel):
    ...
    route: Optional[str] = Field(
        None, description="URL route pattern, e.g. /api/users/:id"
    )
...
class SmtpRequestContext(BaseModel):
    ...
    recipient_conditions: Optional[list[Condition]] = Field(
        None, alias="recipientConditions"
    )
    subject_conditions: Optional[list[Condition]] = Field(
        None, alias="subjectConditions"
    )
